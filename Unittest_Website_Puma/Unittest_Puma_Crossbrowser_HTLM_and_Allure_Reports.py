...
class Chrome_Puma_Test(unittest.TestCase):
    ...
    def test05_positive_edit_address_in_book(self):
        ...
        # Change address book
        driver.find_element(By.XPATH, HP.button_edit_address_chrome).click()
        wait.until(EC.visibility_of_element_located((By.XPATH, HP.wait_new_address)))
...
class Edge_Puma_Test(unittest.TestCase):
    ...
    def test04_positive_address_book(self):
        ...
        driver.find_element(By.XPATH, HP.add_new_address).click()
        wait.until(EC.visibility_of_element_located((By.XPATH, HP.wait_new_address)))
        driver.find_element(By.ID, HP.address_title_input).send_keys(HP.address_title_edge)
        driver.find_element(By.XPATH, HP.country).click()
        driver.find_element(By.ID, HP.first_name).send_keys(fake.first_name())
        driver.find_element(By.ID, HP.last_name).send_keys(fake.last_name())
        driver.find_element(By.ID, HP.address1).send_keys(HP.address_edge)
        driver.find_element(By.ID, HP.city_input).send_keys(HP.city)
        driver.find_element(By.ID, HP.postalCode).send_keys(HP.postal_code_edge)
        driver.find_element(By.XPATH, HP.state).click()
        driver.find_element(By.ID, HP.phone_input).send_keys(HP.phone_number_edge)
        # Make default address
        #driver.find_element(By.ID, HP.button_default_address).click()
        # Submit
        driver.find_element(By.XPATH, HP.button_submit_contains).click()
    ...
    def test05_positive_edit_address_in_book(self):
        ...
        # Change address book
        wait.until(EC.visibility_of_element_located((By.XPATH, HP.wait_menu_address)))
        driver.find_element(By.XPATH, HP.button_edit_address_edge).click()
        wait.until(EC.visibility_of_element_located((By.XPATH, HP.wait_new_address)))
        addressTitle = driver.find_element(By.ID, HP.address_title_input)
        addressTitle.clear()
        addressTitle.send_keys(HP.address_title_new_edge)
        address1 = driver.find_element(By.ID, HP.address1)
        address1.clear()
        address1.send_keys(HP.address_new_edge)
        postalcode = driver.find_element(By.ID, HP.postalCode)
        postalcode.clear()
        postalcode.send_keys(HP.postal_code_new_edge)
        driver.find_element(By.XPATH, HP.button_submit_contains).click()
    ...
    def test02_negative_registration_incorrect_password(self):
        ...
        driver.find_element(By.NAME, HP.fake_first_name).send_keys(fake.first_name())
        driver.find_element(By.NAME, HP.fake_last_name).send_keys(fake.last_name())
        driver.find_element(By.NAME, HP.email_1).send_keys(HP.gmail_edge2)
        driver.find_element(By.NAME, HP.fake_password).send_keys(HP.incor_password)
        driver.find_element(By.XPATH, HP.button_submit).click()
        time.sleep(3)
        driver.find_element(By.XPATH, HP.registration_form_error)
...
class Safari_Puma_Test(unittest.TestCase):
    ...
    def test02_positive_registration_user_account(self):
        ...
        # fake email doesn't work
        # You need to change email1 every time you test
        driver.find_element(By.NAME, HP.email_1).send_keys(HP.gmail_safari)
        driver.find_element(By.NAME, HP.fake_password).send_keys(fake.password())
        time.sleep(3)
        driver.find_element(By.XPATH, HP.button_submit).click()
        time.sleep(3)
    ...
    def test04_positive_address_book(self):
        ...
        driver.find_element(By.XPATH, HP.add_new_address).click()
        wait.until(EC.visibility_of_element_located((By.XPATH, HP.wait_new_address)))
        driver.find_element(By.ID, HP.address_title_input).send_keys(HP.address_title_safari)
        driver.find_element(By.XPATH, HP.country_safari1).click()
        driver.find_element(By.XPATH, HP.country_safari2).click()
        driver.find_element(By.ID, HP.first_name).send_keys(fake.first_name())
        driver.find_element(By.ID, HP.last_name).send_keys(fake.last_name())
        driver.find_element(By.ID, HP.address1).send_keys(HP.address_safari)
        driver.find_element(By.ID, HP.city_input).send_keys(HP.city)
        driver.find_element(By.ID, HP.postalCode).send_keys(HP.postal_code_safari)
        driver.find_element(By.XPATH, HP.state_safari1).click()
        driver.find_element(By.XPATH, HP.state_safari2).click()
        driver.find_element(By.ID, HP.phone_input).send_keys(HP.phone_number_safari)
        # Make default address
        #driver.find_element(By.ID, HP.button_default_address).click()
        # Submit
        driver.find_element(By.XPATH, HP.button_submit_contains).click()
    ...
    def test05_positive_edit_address_in_book(self):
        ...
        driver.find_element(By.XPATH, HP.button_edit_address_safari).click()
        wait.until(EC.visibility_of_element_located((By.XPATH, HP.wait_new_address)))
        addressTitle = driver.find_element(By.ID, HP.address_title_input)
        addressTitle.clear()
        addressTitle.send_keys(HP.address_title_new_safari)
        address1 = driver.find_element(By.ID, HP.address1)
        address1.clear()
        address1.send_keys(HP.address_new_safari)
        postalcode = driver.find_element(By.ID, HP.postalCode)
        postalcode.clear()
        postalcode.send_keys(HP.postal_code_new_safari)
        driver.find_element(By.XPATH, HP.button_submit_contains).click()
    ...
    def test02_negative_registration_incorrect_password(self):
        ...
        driver.find_element(By.NAME, HP.fake_first_name).send_keys(fake.first_name())
        driver.find_element(By.NAME, HP.fake_last_name).send_keys(fake.last_name())
        driver.find_element(By.NAME, HP.email_1).send_keys(HP.gmail_safari2)
        driver.find_element(By.NAME, HP.fake_password).send_keys(HP.incor_password)
        driver.find_element(By.XPATH, HP.button_submit).click()
        time.sleep(3)
        driver.find_element(By.XPATH, HP.registration_form_error)
    ...
    def test05_negative_login_user_account_invalid_email(self):
        ...
        try:
            driver.find_element(By.XPATH, HP.login_form_error)
            print(
                "Negative Test PASSED. Invalid login or password. Remember that login names and passwords are case-sensitive. Please try again!")
        except WDE:
            print("Negative Test FALSE. Logged in to your account!")
